...
public class SQLOrder implements ISQLEOrder {
    ...
    public ArrayList<Order> findOrder(Order obj) {
        String str = "select idorder, iduser, contents, date\n" +
    ...
    public ArrayList<Order> findOrderClient(int id, Order obj) {
        String str = "select idorder, contents, date\n" + "from orders" +
                " where `orders`.iduser = \"" + id +"\"" + " and `orders`.idorder = \"" + obj.getId() +"\";";
    ...
    public Order getOrder(Role r) {
        String str = "select name, category\n" + "from equipment;";
